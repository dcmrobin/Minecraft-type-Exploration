// Terrain generation is now handled by the new ChunkGenerationPipeline system.
// This file only contains jobs still used elsewhere (e.g., lighting, mesh jobs).
...
// Lighting and mesh jobs may remain if still referenced elsewhere in the codebase.
// Remove the GenerateJob and any other terrain generation jobs.
